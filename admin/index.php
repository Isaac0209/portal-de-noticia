...
<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300&display=swap" rel="stylesheet">
    ...
    <title><?php echo gera_titulo("Painel de administração", true, $con);?></title>
  </head>
        ...
        <div class="nav-menu">
          <ul>
              ...
              <div id="collapseOne" class="collapse" aria-labelledby="headingOne">
                <div>
                  <ul>
                    ...
                    <li><a href="admin/criar">Cadastrar Jornalista</a></li>
                     <li><a href="admin/gerenciar-jornalista">Gerenciar Jornalista</a></li>
                      <li><a href="admin/informacoes">Informações do email</a></li>
            ...
            <li class="accordion">
              ...
              <div id="collapseTwo" class="collapse" aria-labelledby="headingOne">
                <div>
                  <ul>
                    ...
                    <li><a href="admin/gerenciar-posts">Gerenciar Publicação</a></li>
                    <li><a href="admin/limpar-manchete">Limpar manchete</a></li>
             ...
             <li class="accordion">
              <a href="#" data-toggle="collapse" data-target="#collapseTree" aria-expanded="false" aria-controls="collapseTree" class="collapsible">
                <span class="icon-search2 mr-3"></span>Avisos
              </a>

              <div id="collapseTree" class="collapse" aria-labelledby="headingOne">
                <div>
                  <ul>
                    <li><a href="admin/criaraviso">Cadastrar aviso</a></li>
                    <li><a href="admin/gerenciar-avisos">Gerenciar avisos</a></li>
             ...
             <li class="accordion">
              ...
              <div id="collapse4" class="collapse" aria-labelledby="headingOne">
                <div>
                  <ul>
                    <li><a href="admin/uparfoto">Upar Foto</a></li>
                    <li><a href="admin/gerenciar-foto">Gerenciar Foto</a></li>
             ...
             <li class="accordion">
              <a href="#" data-toggle="collapse" data-target="#collapse5" aria-expanded="false" aria-controls="collapse5" class="collapsible">
                <span class="icon-search2 mr-3"></span>Feedback
              </a>

              <div id="collapse5" class="collapse" aria-labelledby="headingOne">
                <div>
                  <ul>
                    <li><a href="admin/ver">Ver Feedback</a></li>
             ...
             <li><a href="admin/perfil"><span class="icon-sign-out mr-3"></span>Editar perfil</a></li>
            <li><a href="admin/sair"><span class="icon-sign-out mr-3"></span>Sair</a></li>
          </ul>
        </div>
      </div>
