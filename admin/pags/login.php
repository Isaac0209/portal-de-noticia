...
<div class="alert alert-warning">Seu IP será gravado por motivos de segurança</div>
...
<?php
 	...
 	if(isset($_POST['env']) && $_POST['env'] == "log"){
		if($_POST['usuario'] && $_POST['senha']){
			...
			if ($_SESSION['usuarioNivel'] == "Jornalista") {
				echo "<div class='alert alert-danger'>Jornalista!,acesso negado.</div>";
				session_destroy();
			}else 
