...
function bold(n){
    ...
    if(typeof n !=='string'){
        switch(n){
            ...
            break
            case 6: a.texto.value=`${valor.comeco} <a href="LINK AQUI" class="link22">${valor.meio}</a> ${valor.final}`
            break
            ...
            break
            case 10: a.texto.value=`${valor.comeco} ${valor.meio}<br class="br1"> ${valor.final}`
            break
            case 11: a.texto.value=`${valor.comeco} <span class="marcacao">${valor.meio}</span> ${valor.final}`
            break
            case 12: a.texto.value=`${valor.comeco} <blockquote class="block">${valor.meio}</blockquote> ${valor.final}`
            break
            case 13: a.texto.value=`${valor.comeco}<figure> <img class="imagempublic" src="Link da imagem"><figcaption class="descricao">${valor.meio}</figcaption></figure> ${valor.final}`
            break
            case 14: a.texto.value='Errei'
            break
