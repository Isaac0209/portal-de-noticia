<?php
	...
	function protegePagina($explode, $isAdmin){
		$paginas_protegidas = array("inicio", "publicar", "gerenciar-posts", "editar-post", "deletar-post", "perfil", "cadastrar-att", "criar.php", "criaraviso", "deletar-aviso", "deletar-perfil", "editar-aviso", "editar-perfil", "gerenciar-aviso", "gerenciar-foto", "gerenciar-jornalista", "limpar-att", "limpar-ip", "uparfoto");
